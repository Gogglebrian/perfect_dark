...
struct mpweapon g_MpWeapons[NUM_MPWEAPONS] = {
	...
	/*0x14*/ { WEAPON_SNIPERRIFLE,      AMMOTYPE_SNIPER_PIERCING, 12, AMMOTYPE_SNIPER_EXPLOSIVE, 12, 1, 0,                       MODEL_CHRSNIPERRIFLE,   256 },
	...
	/*0x31*/ { WEAPON_U13ERKL01313,     AMMOTYPE_SMG,         200, 0,                   0,  1, 0,                                MODEL_CHRSKORPION,      256 },
	/*0x32*/ { WEAPON_DISABLED }, // 0x25 on N64
};
...
void mpInit(bool resetplayers)
{
	...
	g_MpSetup.options |= MPOPTION_ENHANCEDSIMTARGETING;
#endif
